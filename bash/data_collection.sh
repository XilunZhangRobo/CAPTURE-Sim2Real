...
python -m scripts.collect_data --mode train --env_name scoop --n_history 7 --n_data 80000 --n_env 100 --policy_name sac --policy_checkpoint data/policy_model/scoop/sac/0/model_checkpoint_144000_steps.zip
python -m scripts.collect_data --mode eval  --env_name scoop --n_history 7 --n_data 100   --n_env 100 --policy_name sac --policy_checkpoint data/policy_model/scoop/sac/0/model_checkpoint_144000_steps.zip
